...
etinfo = lsl_resolve_byprop(lib,'name','TobiiPro');
...
while true
    ...
    scatter(et_sample(7),1-et_sample(8),et_sample(end)*100, 'd','filled', 'MarkerFaceColor', rightcolor), xlim([0,1]), ylim([0,1])
    text(et_sample(7),1-et_sample(8),'R')
